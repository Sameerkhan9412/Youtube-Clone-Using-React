...
const VideoContainer = () => {
  ...
  return (
    ...
    <div className='h-[calc(100vh-6.6rem)]  overflow-y-scroll custom-scrollbar1 grid  grid-cols-1 gap-4 items-baseline md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5' >
      {
        videos.map((video)=>(
